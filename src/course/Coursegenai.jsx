        ...
        <div className="h-[92vh] w-screen bg-base-300 pt-10">
            <div className="card card-side bg-base-100 shadow-xl w-1/2 mx-auto">
                ...
                <div className="card-body">
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/y4SLh1cpap4?si=w9Gdq0TsQWD9IdGp" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
